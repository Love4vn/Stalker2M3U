...
def generate_playlist(portals: List[Dict], output_file: str):
    ...
    SPORTS_KEYWORDS = [
        ...
        "motorsport", "formula 1", "f1", "hub premier", "premier league", "disney+ premium",
